...
| D4 cache | x-vercel-cache HIT on the second read of four public pages | pass | /: HIT 201 ms; /journals: HIT 278 ms; /feed: HIT 188 ms; /bg/journal/ove-371-codec-proof-52f59ed8b101: HIT 172 ms |
| D2 delivery | entry photos have srcset and no /_next/image | pending | 5 entries with photos, 0 with srcset (needs migration 0047 for photos published after it), 0 through the optimizer |
