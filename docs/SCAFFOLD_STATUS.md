...
- Production DigitalOcean Managed Postgres backup/PITR checks.
...
- iOS Safari offline capture manual field smoke on a real device. OVE-38 landed the offline photo-byte hardening and a mobile WebKit field-equivalent run; the real-device run on the OVE-37 pilot URL is the remaining OVE-38 Done gate.
