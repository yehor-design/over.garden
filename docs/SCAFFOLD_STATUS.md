...
Continue the current SDD Slice 4 execution batch from Linear. After `OVE-25`, the next strongest vertical issue is pilot health readout (`OVE-26`) before production pilot smoke, unless live review finds a blocking privacy-gate defect.
