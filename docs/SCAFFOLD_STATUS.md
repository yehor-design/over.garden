...
Continue the current SDD Slice 4 execution batch from Linear. After `OVE-24`, the next strongest vertical issue is the launch privacy gate (`OVE-25`) before production pilot smoke, unless live review finds a blocking acquisition-path defect.
