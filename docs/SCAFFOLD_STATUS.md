...
Continue the current SDD Slice 4 execution batch from Linear. Pick the next vertical issue that closes a concrete pilot-retention behavior across authenticated workspace action, offline/media boundary when relevant, privacy-safe events, and docs/tests.
