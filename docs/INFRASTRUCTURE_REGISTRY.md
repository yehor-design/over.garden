...
Last verified: 2026-08-11 for the OVE-314 aggregate production database/env preflight and current repository contract (provider removal waits for exact-SHA deployment); 2026-08-10 for the OVE-290 R2 presign TTL preflight and stale-document media contract; other provider verification dates remain recorded per section
