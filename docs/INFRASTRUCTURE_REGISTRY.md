...
- OVE-298 Production rollback classification on 2026-08-12 is `googleAccountRowCount=1` with zero duplicate Google-subject groups, zero duplicate Google-user groups, zero missing Google subjects, and zero invalid Google-provider rows. Migration `0022` digest is `6392a41f971176eb9de748f54fc15beb76a6a77f8a755694d327fe8eae40f6bd`; the redacted database-target digest is `84503a97fba4e9febf14db87091ce05d2866796d78109f812a649c23f9c36462`. Both approved indexes are now exact with definition digests `fed091a72b61aa8d9b9573dadeeb345dbcdea979b7173154dddac81a9fbe7dbe` and `9e68f3c994090992c14869a501de524e96135484426b03dca2211b3bcdba4e66`. The first approved attempt consumed its one link initiation but lost the isolated browser before callback; it therefore failed closed. `GOOGLE_ACCOUNT_LINKING_ENABLED` is absent again, the sole disposable fixture is absent after canonical erasure, its request is anonymized and completed, and no provider grant or callback is accepted as proven. Canonical deployment `dpl_Aws4xUADKsWMSiQcQSNe22vK3HNA` is READY on exact main `657066b9e94972980e3a6109286c15e05c7c3de1` with both aliases. A new callback requires exact approval of `docs/runbooks/OVE_298_PRODUCTION_GOOGLE_LINK_PROOF_RETRY_PLAN.md`; its effect bound is `indexCreates=0` and all other one-fixture bounds remain one. The retry must preserve OVE-314 by denying the sealed owner in both account-method projection and direct pre-provider-state server admission.
