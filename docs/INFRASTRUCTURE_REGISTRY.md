...
- Whalebone global false-positive report for `over.garden` and `www.over.garden` was delivered on 2026-07-13 through a verified OverGarden sender with a monitored reply channel. No provider case ID has been assigned yet; the review outcome is `pending`. The submission contained bounded technical evidence and no visitor IP, account data, cookie, token, private content, or raw block-page passthrough URL.
