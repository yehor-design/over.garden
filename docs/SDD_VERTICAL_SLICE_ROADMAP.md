...
Date: 2026-06-26
Last operational update: 2026-07-13 (living-object and journal creation V2)
Owner: founder
...
`OVE-187` remains the production-refusing visual-data prerequisite for the reconstruction: its v6 manifest deterministically seeds real repositories and routes with 8 profiles, 10 spaces, 30 mixed living objects, 81 journals, 16 generated raster derivatives, 7 curated topics, 40 accepted public signals, explicit feed/catalog/journal-directory/knowledge/passport/profile/workspace/creation/empty/404/410/gallery scenarios, a real five-plus-five public journal disclosure, and 21 credential-free OVE-174 intent scenarios including real IndexedDB first-entry/follow-up draft retention, a permission-changed follow-up boundary, and a profile target. Its evidence owns 11 journal-directory URL/count/ordered-ID cases, 10 knowledge entry/object cases, 14 public/owner passport cases, 17 journal-entry cases, 10 profile cases, 8 owner-workspace cases, and 20 resettable OVE-182 creation cases, and verifies them against canonical SQL/loaders while preserving unrelated local records. Local fixture mode requires loopback database and object-store/public-media endpoints. Continue from the current Linear blocker order; every remaining production behavior must use this fixture environment for desktop/mobile evidence instead of approving empty or one-record screens. The operator contract is `docs/VISUAL_FIXTURE_ENVIRONMENT.md`.
