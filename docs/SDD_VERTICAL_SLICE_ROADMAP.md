...
Date: 2026-06-26
Last operational update: 2026-07-11 (public knowledge and journal evidence)
Owner: founder
...
`OVE-187` remains the production-refusing visual-data prerequisite for the reconstruction: its versioned manifest deterministically seeds real repositories and routes with 4 profiles, 5 spaces, 30 mixed living objects, 80 journals, 16 generated raster derivatives, 7 curated topics, 40 accepted public signals, explicit feed/catalog/journal-directory/knowledge/empty/404/410/gallery scenarios, a real five-plus-five public journal disclosure, and 19 credential-free OVE-174 intent scenarios including real IndexedDB first-entry/follow-up draft retention, a permission-changed follow-up boundary, and a profile target. Its evidence owns 11 journal-directory URL/count/ordered-ID cases plus 10 knowledge entry/object cases and verifies them against canonical SQL while preserving unrelated local records. Local fixture mode requires loopback database and object-store/public-media endpoints. Continue from the current Linear blocker order; every remaining production behavior must use this fixture environment for desktop/mobile evidence instead of approving empty or one-record screens. The operator contract is `docs/VISUAL_FIXTURE_ENVIRONMENT.md`.
