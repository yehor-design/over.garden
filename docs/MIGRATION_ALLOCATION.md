...
| `0071` | `OVE-429` | the generated `CHECK` on `catalog_items.public_slug`, which the re-slug makes possible; the addresses themselves move in `pnpm address:catalog:reslug` |
