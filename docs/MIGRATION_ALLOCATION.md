...
| `0069` | `OVE-426` | widens the `journal_topics.slug` CHECK to the manifest's native-script `topic` shape; the block is `contracts/address/address-slug-checks.generated.sql` verbatim |
