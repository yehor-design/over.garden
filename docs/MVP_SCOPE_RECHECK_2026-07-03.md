...
- Public SEO/AEO starts at MVP launch. Blog, guides, market landings, and useful answer pages may be public and indexable from day one. *Superseded on 2026-09-02 by ADR-0022 D3:* every live public page is indexable; the only `noindex` cases are empty listings, gone records, and workspace/auth/operator routes. The former quality gates for thin UGC, variety, topic, lineage, and profile pages are gone.
