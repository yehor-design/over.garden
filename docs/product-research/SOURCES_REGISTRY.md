...
>
> Ліцензійні вердикти по джерелах — чинні й досі використовуються. Спосіб споживання
> змінився: Stable Registry (карантин → незмінний реліз → гейти → проєкція), а не
> масовий сід. Живий гейт джерел — `CATALOG_SOURCE_READINESS.md`.
