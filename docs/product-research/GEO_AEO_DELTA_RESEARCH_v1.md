...
>
> **Не діє:** рекомендації, зав'язані на пороги індексації. **Діє:** GEO/AEO-каталог
> як такий. Доповнення з коду: публічні сторінки рендеряться у стримлених Suspense-межах,
> тож без JavaScript видимих символів нуль; агенти, що не виконують скрипти, отримують
> повний блокуючий рендер від Next (ADR-0024 D3).
