...
| Issue                                                                                                                       | Required state before OVE-51/OVE-52/OVE-53                                                                        | Main proof                                 | CI proof                                                                                   |
| --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------ |
...
The current queue after OVE-50 is OVE-51 -> OVE-52 -> OVE-53 in the Linear project `SDD Slice 8 - Mainline Recovery And Pilot Decision Quality`.
