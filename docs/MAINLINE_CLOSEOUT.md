...
| [OVE-206](https://linear.app/overgarden/issue/OVE-206/accessible-story-block-reordering-gardener-drags-or-moves-every) | Accessible pointer/touch/keyboard block reorder via `blocks.move`, locale in-flight gesture fence, live-region/focus, 100-block/10-image identity, and `browser-backed` scenario `pointer-commit-immediate-transition` are on `main` with exact-SHA Vercel READY; founder physical iPhone Safari checklist pending before Linear Done. | `c06fa2ce30d473ae591453e24c09bc949cc1dae6` | Budget freeze: Vercel `dpl_DB1wi9J1AVpLb8JAxX11aqxEKbkg` READY + local smoke/lint/typecheck/full test |
