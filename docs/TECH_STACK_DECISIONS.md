...
| Media processing        | WebP format conversion is the MVP contract. OVE-333/334 retire standalone actual-byte, quarantine, metadata-strip, and original-deletion readiness promises; current runtime stays unchanged until those owners land.                                                                                 |
