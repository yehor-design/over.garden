...
| Object storage          | Cloudflare R2; ADR-0019 uses private ephemeral staging for direct browser upload of final WebPs and immutable public storage after atomic publication. OVE-349 removed the application-owned private-original quarantine path; its empty provider resource is isolated until OVE-350.              |
