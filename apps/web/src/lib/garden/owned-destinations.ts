...
export const DESTINATION_COPY = {
  uk: {
    ...
    loading: "Шукаємо…",
    noDestinations: "У вас ще немає створених просторів чи об’єктів.",
    noSpaces: "У вас ще немає створених просторів.",
    noObjects: "У вас ще немає створених об’єктів.",
  ...
  bg: {
    ...
    loading: "Търсим…",
    noDestinations: "Все още нямате създадени пространства или обекти.",
    noSpaces: "Все още нямате създадени пространства.",
    noObjects: "Все още нямате създадени обекти.",
  ...
  ru: {
    ...
    loading: "Ищем…",
    noDestinations: "У вас пока нет созданных пространств или объектов.",
    noSpaces: "У вас пока нет созданных пространств.",
    noObjects: "У вас пока нет созданных объектов.",
