...
const COPY: Record<PublicLocale, JournalCoverControlsCopy> = {
  uk: {
    ...
    currentLabel: "Обрано",
    valueInline: "Фото з історії",
    valueSeparate: "Окреме фото",
    photoOrdinal: "Фото {index}",
  },
  bg: {
    sectionLabel: "Корица",
    sectionHint:
    ...
    currentLabel: "Избрано",
    valueInline: "Снимка от историята",
    valueSeparate: "Отделна снимка",
    photoOrdinal: "Снимка {index}",
  },
  ru: {
    ...
    valueInline: "Фото из истории",
    valueSeparate: "Отдельное фото",
    photoOrdinal: "Фото {index}",
  },
};
