...
export const REAL_CLOSED_PILOT_ACTOR_CLASS = "real_closed_pilot" as const;
...
/** @deprecated Prefer REAL_CLOSED_PILOT_ACTOR_CLASS (OVE-200 rename). */
export const CLOSED_PILOT_ACTOR_CLASS = REAL_CLOSED_PILOT_ACTOR_CLASS;
...
export const LEGACY_ACTOR_CLASS_ALIASES = {
  ...
  closed_pilot: REAL_CLOSED_PILOT_ACTOR_CLASS,
...
export function isDecisionEligibleActorClass(
  ...
  return (
    normalized === REAL_SELF_SERVE_ACTOR_CLASS ||
    normalized === REAL_CLOSED_PILOT_ACTOR_CLASS
  );
}
...
export function actorClassFromPilotCohort(
  ...
  if (cohort === "closed_pilot") return REAL_CLOSED_PILOT_ACTOR_CLASS;
