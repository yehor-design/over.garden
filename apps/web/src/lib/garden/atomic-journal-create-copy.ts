...
const COPY: Record<PublicLocale, AtomicJournalCreateCopy> = {
  uk: {
    ...
    localOnly:
      "Зміни ще не опубліковано. Текст існує лише в цій вкладці; оновлення або закриття сторінки відкине неопубліковані зміни.",
    ...
    leaveDescription:
      "Зміни ще не опубліковано. Якщо піти зараз, ви втратите введений текст і вибрані фото — чернеток немає.",
  ...
  bg: {
    ...
    localOnly:
      "Промените още не са публикувани. Текстът съществува само в този раздел; обновяване или затваряне на страницата отхвърля непубликуваните промени.",
    ...
    photoFailed:
      "Снимката не можа да бъде подготвена. Заменете или я премахнете.",
    leaveTitle: "Да излезете без публикуване?",
    leaveDescription:
      "Промените още не са публикувани. Ако излезете сега, ще загубите въведения текст и избраните снимки — няма запазени чернови.",
  ...
  ru: {
    ...
    localOnly:
      "Изменения ещё не опубликованы. Текст существует только в этой вкладке; обновление или закрытие страницы удалит неопубликованные изменения.",
    ...
    leaveDescription:
      "Изменения ещё не опубликованы. Если уйти сейчас, вы потеряете введённый текст и выбранные фото — сохранённых черновиков нет.",
