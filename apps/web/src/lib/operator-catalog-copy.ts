...
const UK: OperatorCatalogCopy = {
  access: {
    ...
    deniedBody:
      "Черга рішень і джерела каталогу відкриті тільки власникові. Ваш акаунт їх не бачить.",
...
const BG: OperatorCatalogCopy = {
  access: {
    ...
    deniedBody:
      "Опашката с решения и източниците на каталога са отворени само за собственика. Вашият акаунт не ги вижда.",
...
const RU: OperatorCatalogCopy = {
  access: {
    ...
    deniedBody:
      "Очередь решений и источники каталога открыты только владельцу. Ваш аккаунт их не видит.",
