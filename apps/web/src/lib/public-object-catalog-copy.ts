...
const COPY = {
  uk: {
    ...
    metadataDescription:
      "Рослини та тварини з реальними публічними журналами й чесно позначеною ідентичністю, зокрема бджолині породи з каталогу.",
    heading: "Живі об'єкти",
    intro:
      "Рослини й тварини, про які вже є публічні спостереження; бджолині породи розпізнаються за назвою ідентичності в каталозі.",
  ...
  bg: {
    ...
    metadataDescription:
      "Растения и животни с реални публични дневници и ясно означена идентичност, включително пчелни породи от каталога.",
    heading: "Живи обекти",
    intro:
      "Растения и животни с публични наблюдения; пчелните породи се разпознават по името на идентичността в каталога.",
  ...
  ru: {
    ...
    metadataDescription:
      "Растения и животные с реальными публичными журналами и честно обозначенной идентичностью, включая пчелиные породы из каталога.",
    heading: "Живые объекты",
    intro:
      "Растения и животные, о которых уже есть публичные наблюдения; пчелиные породы распознаются по названию идентичности в каталоге.",
