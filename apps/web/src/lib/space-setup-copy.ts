...
export interface SpaceSetupCopy {
  ...
  photo: {
    question: string;
    /** The photo's `alt`: «Фото простору «Балкон»». */
...
const uk: SpaceSetupCopy = {
  ...
  photo: {
    question: "Додайте фото простору",
    alt: (name) => `Фото простору «${name}»`,
    skip: "Пропустити",
    create: "Створити",
    creating: "Створюємо…",
  },
  discard: {
    title: "Вийти зі створення простору?",
    body: "Назва й фото не збережуться.",
    keep: "Продовжити створення",
    leave: "Вийти",
  },
  duplicate: {
...
const bg: SpaceSetupCopy = {
  ...
  photo: {
    question: "Добавете снимка на пространството",
    alt: (name) => `Снимка на пространството „${name}“`,
    skip: "Пропусни",
    create: "Създай",
    creating: "Създаваме…",
  },
  discard: {
    title: "Излизане от създаването на пространство?",
    body: "Името и снимката няма да бъдат запазени.",
    keep: "Продължи създаването",
    leave: "Излез",
  },
  duplicate: {
...
const ru: SpaceSetupCopy = {
  ...
  photo: {
    question: "Добавьте фото пространства",
    alt: (name) => `Фото пространства «${name}»`,
    skip: "Пропустить",
    create: "Создать",
    creating: "Создаём…",
  },
  discard: {
    title: "Выйти из создания пространства?",
    body: "Название и фото не сохранятся.",
    keep: "Продолжить создание",
    leave: "Выйти",
  },
  duplicate: {
