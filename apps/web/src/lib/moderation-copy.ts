...
const UK_COPY = {
  ...
  accessDenied:
    "Модерувати можуть власник і призначені модератори. Цей обліковий запис до них не належить.",
  ...
  comments: {
    ...
    accessDenied:
      "Модерувати коментарі може лише власник. Цей обліковий запис ним не є.",
...
const BG_COPY: ModerationCopy = {
  ...
  accessDenied:
    "Модерират собственикът и назначените модератори. Този профил не е сред тях.",
  ...
  comments: {
    ...
    accessDenied:
      "Коментарите може да модерира само собственикът. Този профил не е собственикът.",
...
const RU_COPY: ModerationCopy = {
  ...
  accessDenied:
    "Модерировать могут владелец и назначенные модераторы. Эта учётная запись к ним не относится.",
  ...
  comments: {
    ...
    accessDenied:
      "Модерировать комментарии может только владелец. Эта учётная запись им не является.",
