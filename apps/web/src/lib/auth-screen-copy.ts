...
const UK: AuthScreenCopy = {
  ...
  signUp: {
    title: "Новий акаунт",
    description:
      "Акаунт потрібен, щоб вести сад і публікувати записи. Опубліковані записи бачать усі.",
  },
  intentDescription:
    "Після входу ви повернетеся туди, де були, до тієї самої дії.",
  pending: {
    signIn: "Входимо…",
    signUp: "Створюємо акаунт…",
  ...
  signedIn: {
    ...
    switchAccount: "Щоб увійти в інший акаунт, спершу вийдіть.",
  },
  returnToTab: {
  ...
  help: {
    ...
    description:
      "Надішлемо одноразове посилання, щоб ви задали новий пароль для того самого акаунта.",
    back: "Назад до входу",
    rateLimited:
...
const BG: AuthScreenCopy = {
  ...
  signUp: {
    title: "Нов акаунт",
    description:
      "Акаунтът е нужен, за да водите градина и да публикувате записи. Публикуваните записи са видими за всички.",
  },
  intentDescription:
    "След като влезете, ще се върнете там, където бяхте, към същото действие.",
  pending: {
    signIn: "Влизане…",
    signUp: "Създаване на акаунта…",
    social: "Към Google…",
  ...
  signedIn: {
    ...
    switchAccount: "За да влезете с друг акаунт, първо излезте.",
  },
  returnToTab: {
  ...
  help: {
    title: "Помощ за вход",
    description:
      "Ще изпратим еднократна връзка, за да зададете нова парола за същия акаунт.",
