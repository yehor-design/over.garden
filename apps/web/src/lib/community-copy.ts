...
const COPY: Record<PublicLocale, CommunityCopy> = {
  uk: {
    ...
    participationSummary:
      "Учасники додають сюди свої опубліковані записи про рослини й тварин і обговорюють їх. Приєднатися може кожен, хто має акаунт.",
  ...
  bg: {
    ...
    topicLabel: "Тема",
    participationSummary:
      "Членовете добавят тук своите публикувани записи за растения и животни и ги обсъждат. Всеки с акаунт може да се присъедини.",
  ...
  ru: {
    ...
    topicLabel: "Тема",
    participationSummary:
      "Участники добавляют сюда свои опубликованные записи о растениях и животных и обсуждают их. Присоединиться может любой, у кого есть аккаунт.",
