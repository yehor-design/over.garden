...
const UK_COPY = {
  ...
  composer: {
    ...
    queue: {
      title: "Продовження, збережені на цьому пристрої",
      saved: "Збережене продовження",
      untitled: "Продовження без заголовка",
      context: "Продовження для цього живого об'єкта",
    },
  },
  privacy: {
  ...
  entryActions: {
    ...
    publicAvailable:
      "Публічна сторінка доступна. Під час пілоту її не додають до індексів пошукових систем.",
    ...
    publicationPilot:
      "Під час пілоту публічні сторінки не додають до індексів пошукових систем, але це не гарантує таємності.",
  ...
  valuePulse: {
    ...
    description:
      "Після цього продовження чи здається вам, що історію живого об'єкта варто зберігати? Відповідь залишається приватною й допомагає поліпшити пілот.",
    usefulness: {
...
const BG_COPY = {
  ...
  composer: {
    ...
    queue: {
      title: "Продължения, запазени на това устройство",
      saved: "Запазено продължение",
      untitled: "Продължение без заглавие",
      context: "Продължение за този жив обект",
    },
  },
  privacy: {
  ...
  entryActions: {
    ...
    publicAvailable:
      "Публичната страница е достъпна. По време на пилота не се включва в индексите на търсачките.",
    ...
    publicationPilot:
      "По време на пилота публичните страници не се включват в индексите на търсачките, но това не е гаранция за поверителност.",
  ...
  valuePulse: {
    ...
    description:
      "След това продължение струва ли си да пазите историята на живия обект? Отговорът остава частен и ни помага да подобрим пилота.",
    usefulness: {
...
const RU_COPY = {
  ...
  composer: {
    ...
    queue: {
      title: "Продолжения, сохранённые на этом устройстве",
      saved: "Сохранённое продолжение",
      untitled: "Продолжение без заголовка",
      context: "Продолжение для этого живого объекта",
    },
  },
  privacy: {
  ...
  entryActions: {
    ...
    publicAvailable:
      "Публичная страница доступна. Во время пилота она не включается в индексы поисковых систем.",
    ...
    publicationPilot:
      "Во время пилота публичные страницы не включаются в индексы поисковых систем, но это не гарантирует конфиденциальность.",
  ...
  valuePulse: {
    ...
    description:
      "После этого продолжения кажется ли вам, что историю живого объекта стоит сохранять? Ответ остаётся приватным и помогает улучшить пилот.",
    usefulness: {
