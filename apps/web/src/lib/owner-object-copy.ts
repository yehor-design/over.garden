...
const UK_COPY = {
  ...
  settingsPage: {
    ...
    description:
      "Фото, приватність місця, відповідність каталогу й джерело даних. Записи від цього не змінюються.",
    photoTitle: "Фото",
    photoAlt: "Фото «{name}»",
...
const BG_COPY = {
  ...
  settingsPage: {
    ...
    description:
      "Снимка, поверителност на мястото, съответствие с каталога и източник на данни. Записите не се променят.",
    photoTitle: "Снимка",
...
const RU_COPY = {
  ...
  settingsPage: {
    ...
    description:
      "Фото, приватность места, соответствие каталогу и источник данных. Записи от этого не меняются.",
    photoTitle: "Фото",
    photoAlt: "Фото «{name}»",
