...
const UK_COPY = {
  ...
  entryActions: {
    ...
    deleteDisclosure:
      "Видалити цей запис назавжди. Він одразу зникне з вашої історії та публічних сторінок; на 7 днів лишиться лише технічний очищений запис для завершення видалення пошуку й фото.",
    deleteButton: "Видалити запис назавжди",
    publicationLead:
...
const BG_COPY = {
  ...
  entryActions: {
    ...
    deleteDisclosure:
      "Изтрийте този запис окончателно. Той веднага ще изчезне от историята и публичните страници; за 7 дни остава само изчистен технически запис, за да завърши премахването от търсенето и снимките.",
    deleteButton: "Изтриване на записа окончателно",
    publicationLead:
...
const RU_COPY = {
  ...
  entryActions: {
    ...
    deleteDisclosure:
      "Удалить эту запись навсегда. Она сразу исчезнет из истории и публичных страниц; на 7 дней останется только очищенная техническая запись для завершения удаления из поиска и фото.",
    deleteButton: "Удалить запись навсегда",
    publicationLead:
