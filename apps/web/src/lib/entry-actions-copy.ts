...
const bg: EntryActionsCopy = {
  ...
  deleteBody:
    "Записът веднага изчезва от историята ви, публичните страници и емисията, а адресът му ще съобщава, че е изтрит. Снимките на записа също се изтриват. За 7 дни остава само технически изчистен запис, за да завърши премахването от търсенето и хранилището. Изтриването не може да бъде отменено.",
