...
const COPY = {
  uk: {
    ...
    claims: {
      ...
      description:
        "Інший садівник каже, що його рослина чи тварина походить від вашої. Поки ви не підтвердите, це ніде не показано: підтвердження робить зв'язок публічним, відмова не робить нічого.",
    ...
    updates: {
      ...
      description:
        "Питання — це коли хтось читає ваш публічний запис і просить подробицю: звідки саджанець, як ви його вкорінювали. Відповідь ваша й необов'язкова. Нижче також те, за чим стежите ви.",
  ...
  bg: {
    ...
    claims: {
      ...
      description:
        "Друг градинар твърди, че неговото растение или животно произхожда от вашето. Докато не потвърдите, това не се показва никъде: потвърждението прави връзката публична, отказът не прави нищо.",
    ...
    updates: {
      ...
      description:
        "Въпрос е, когато някой чете вашия публичен дневник и пита за подробност: откъде е разсадът, как сте го вкоренили. Отговорът е ваш и не е задължителен. По-долу е и това, което следите вие.",
  ...
  ru: {
    ...
    claims: {
      ...
      description:
        "Другой садовод говорит, что его растение или животное происходит от вашего. Пока вы не подтвердите, это нигде не показано: подтверждение делает связь публичной, отказ не делает ничего.",
    ...
    updates: {
      ...
      description:
        "Вопрос — это когда кто-то читает вашу публичную запись и просит подробность: откуда саженец, как вы его укореняли. Ответ ваш и необязателен. Ниже также то, за чем следите вы.",
