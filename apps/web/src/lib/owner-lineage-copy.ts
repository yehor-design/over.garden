  ...
  bg: {
    ...
    invitation: {
      ...
      ready: {
        ...
        consequencesTitle: "Какво ще се промени",
        ifConfirm:
          "Потвърждаване: записът за произход на градинаря ще стане потвърден и в него ще се запази, че е отговорил вашият профил.",
        ifDecline:
      ...
      states: {
        ...
        answeredByOtherBody:
          "Отговорил е друг профил, затова не може да се отговори отново. Ако поканата е била за вас, кажете на градинаря, който я е изпратил.",
