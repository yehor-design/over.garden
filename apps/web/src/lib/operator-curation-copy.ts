...
const REGISTRY_UK_COPY = {
  ...
  unavailable:
    "Центр випусків зараз недоступний: базу даних не вдалося прочитати. Дані не змінено.",
  schemaMissing:
    "Схема бази даних не має об'єкта «{relation}». Застосуйте міграцію: docs/MIGRATION_ALLOCATION.md.",
...
const REGISTRY_BG_COPY = {
  ...
  unavailable:
    "Центърът за издания не е достъпен сега: базата данни не може да бъде прочетена. Данните не са променени.",
  schemaMissing:
    "Схемата на базата данни няма обекта „{relation}“. Приложете миграцията: docs/MIGRATION_ALLOCATION.md.",
  releaseCenterDisabled:
...
const REGISTRY_RU_COPY = {
  ...
  unavailable:
    "Центр выпусков сейчас недоступен: базу данных не удалось прочитать. Данные не изменены.",
  schemaMissing:
    "В схеме базы данных нет объекта «{relation}». Примените миграцию: docs/MIGRATION_ALLOCATION.md.",
  releaseCenterDisabled:
...
const EXTENSION_PACK_UK_COPY = {
  ...
  unavailable:
    "Пакети розширень зараз недоступні: базу даних не вдалося прочитати. Дані не змінено.",
  schemaMissing:
    "Схема бази даних не має об'єкта «{relation}». Застосуйте міграцію: docs/MIGRATION_ALLOCATION.md.",
  disabled:
...
const EXTENSION_PACK_BG_COPY = {
  ...
  unavailable:
    "Пакетите разширения не са достъпни сега: базата данни не може да бъде прочетена. Данните не са променени.",
  schemaMissing:
    "Схемата на базата данни няма обекта „{relation}“. Приложете миграцията: docs/MIGRATION_ALLOCATION.md.",
  disabled:
...
const EXTENSION_PACK_RU_COPY = {
  ...
  unavailable:
    "Пакеты расширений сейчас недоступны: базу данных не удалось прочитать. Данные не изменены.",
  schemaMissing:
    "В схеме базы данных нет объекта «{relation}». Примените миграцию: docs/MIGRATION_ALLOCATION.md.",
  disabled:
...
const EDITION_UK_COPY = {
  ...
  unavailable:
    "Видання зараз недоступні: базу даних не вдалося прочитати. Дані не змінено.",
  schemaMissing:
    "Схема бази даних не має об'єкта «{relation}». Застосуйте міграцію: docs/MIGRATION_ALLOCATION.md.",
  disabled:
...
const EDITION_BG_COPY = {
  ...
  unavailable:
    "Изданията не са достъпни сега: базата данни не може да бъде прочетена. Данните не са променени.",
  schemaMissing:
    "Схемата на базата данни няма обекта „{relation}“. Приложете миграцията: docs/MIGRATION_ALLOCATION.md.",
  disabled:
...
const EDITION_RU_COPY = {
  ...
  unavailable:
    "Издания сейчас недоступны: базу данных не удалось прочитать. Данные не изменены.",
  schemaMissing:
    "В схеме базы данных нет объекта «{relation}». Примените миграцию: docs/MIGRATION_ALLOCATION.md.",
  disabled:
