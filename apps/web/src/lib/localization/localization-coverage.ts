  ...
  [
    ...
    ...routes(
      [
        ...
        "src/app/garden/catalog/registry/editions/page.tsx",
...
export const LOCALIZATION_AUTHORED_LITERAL_ALLOWLIST: readonly LocalizationLiteralAllowlistEntry[] =
  [
    ...
    ...allowExactLiterals(
      ...
      "internal-fixture",
      INTERNAL_FIXTURE_RATIONALE,
      [["metadata-title", "Lexical journal fixture | OverGarden"]],
    ),
    ...allowExactLiterals(
      "src/app/%5F%5Fvisual-fixtures/lexical-journal/lexical-journal-visual-fixture.tsx",
      "internal-fixture",
      INTERNAL_FIXTURE_RATIONALE,
      [
        ["jsx-text", "OVE-317 synthetic browser evidence"],
        ["jsx-text", "Synthetic composer unmounted."],
        ["jsx-text", "blocks="],
        ["jsx-text", "; images="],
        ["jsx-text", "; generation="],
        ["jsx-text", "; cancels="],
