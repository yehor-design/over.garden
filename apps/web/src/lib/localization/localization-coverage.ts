  ...
  [
    ...
    ...allowExactLiterals(
      ...
      [
        ...
        [
          "jsx-text",
          "One vertical path through auth, scoped Kysely repositories, Postgres, queueing, and SSR readback.",
        ],
        ["jsx-text", "Journal write path"],
        ["jsx-text", "Signed in as"],
        ["jsx-text", "Entry"],
        ["placeholder", "Помідори чері — first skeleton note"],
        ["jsx-text", "Public test entry"],
        ["jsx-text", "Save entry"],
    ...
    ...allowExactLiterals(
      "src/app/skeleton/skeleton-auth-panel.tsx",
      "diagnostic",
      "This exact walking-skeleton label belongs to the internal infrastructure diagnostic route.",
      [
        ["jsx-text", "Auth skeleton"],
        [
          "jsx-text",
          "Use the local skeleton account to exercise Better Auth cookies.",
        ],
        ["jsx-text", "Create local account"],
        ["jsx-text", "Sign in"],
      ],
    ),
  ];
