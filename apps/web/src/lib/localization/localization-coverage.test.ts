...
describe("OVE-205 market-first localization coverage", () => {
  it("produces one schema-v3 zero-regression-gap inventory across app states and raw lifecycle renderers", () => {
    ...
    expect(report).toMatchObject({
      ...
      summary: {
        routeModuleCount: 114,
        classifiedRouteModuleCount: 114,
        appSurfaceModuleCount: 152,
        classifiedAppSurfaceModuleCount: 152,
        registeredSurfaceCount: 156,
        renderedRouteModuleCount: 73,
        renderedSurfaceCount: 115,
