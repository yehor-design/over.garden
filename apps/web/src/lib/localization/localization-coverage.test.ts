...
describe("OVE-205 market-first localization coverage", () => {
  it("produces one schema-v3 zero-regression-gap inventory across app states and raw lifecycle renderers", () => {
    ...
    expect(report).toMatchObject({
      ...
      summary: {
        routeModuleCount: 112,
        classifiedRouteModuleCount: 112,
        appSurfaceModuleCount: 150,
        classifiedAppSurfaceModuleCount: 150,
        registeredSurfaceCount: 154,
        renderedRouteModuleCount: 71,
        renderedSurfaceCount: 113,
        renderedStateModuleCount: 38,
        ...
        preservedRouteModuleCount: 100,
        newlyClosedDeltaRouteModuleCount: 10,
        ove205CorrectiveSurfaceCount: 44,
