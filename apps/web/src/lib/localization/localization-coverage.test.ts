...
describe("OVE-205 market-first localization coverage", () => {
  it("produces one schema-v3 zero-regression-gap inventory across app states and raw lifecycle renderers", () => {
    ...
    expect(report).toMatchObject({
      ...
      summary: {
        routeModuleCount: 113,
        classifiedRouteModuleCount: 113,
        appSurfaceModuleCount: 151,
        classifiedAppSurfaceModuleCount: 151,
        registeredSurfaceCount: 155,
        renderedRouteModuleCount: 72,
        renderedSurfaceCount: 114,
