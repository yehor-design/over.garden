...
export const LOCALIZATION_OWNER_BROWSER_PROBES: readonly LocalizationOwnerBrowserProbe[] =
  [
    ...
    browserProbe({
      id: "workspace-connection-required",
      owner: "workspace",
      scenarioId: "workspace:workspace-connection-required",
      pathTransform: "identity",
      stateClasses: ["connection-required"],
      viewportIds: REQUIRED_VIEWPORTS,
    }),
    browserProbe({
    ...
    browserProbe({
      ...
      owner: "operator",
      scenarioId: null,
      explicitPath: "/garden/catalog/registry",
      pathTransform: "identity",
