...
const uk: GardenCollectionCopy = {
  ...
  setup: {
    ...
    body: "Сад складається з просторів — балкона, теплиці, ділянки — і рослин чи тварин у них. Додайте першу рослину чи тварину, створіть простір або одразу напишіть перший запис.",
    addObject: "Додати рослину чи тварину",
...
const bg: GardenCollectionCopy = {
  ...
  setup: {
    ...
    body: "Градината се състои от пространства — балкон, оранжерия, парцел — и растения или животни в тях. Добавете първото растение или животно, създайте пространство или направо напишете първия запис.",
    addObject: "Добави растение или животно",
...
const ru: GardenCollectionCopy = {
  ...
  setup: {
    ...
    body: "Сад состоит из пространств — балкона, теплицы, участка — и растений или животных в них. Добавьте первое растение или животное, создайте пространство или сразу напишите первую запись.",
    addObject: "Добавить растение или животное",
