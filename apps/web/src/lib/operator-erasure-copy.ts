...
const UK_COPY = {
  ...
  executionDescription:
    "Виконання видаляє або анонімізує пов'язані із заявником дані поточної схеми: обліковий запис, журнал, медіа, аналітику, тимчасові записи каталогу, search jobs та операторські записи. Об'єкти R2 під контролем OverGarden видаляються, якщо ключі ще відомі; копії зовнішніх crawler, пошукових систем або AI видаляються лише за можливості.",
  approvalPhrase: "Фраза схвалення супроводжувача",
  confirmTitle: "Виконати незворотне видалення за запитом",
  confirmDescription:
    "Дані цього облікового запису буде видалено або анонімізовано. Скасувати це неможливо. Публічні адреси відповідатимуть 410 щонайбільше сім днів, а потім зникнуть.",
  confirmAction: "Так, виконати видалення",
...
const BG_COPY: OperatorErasureCopy = {
  ...
  confirmTitle: "Изпълни необратимо изтриване по заявката",
  confirmDescription:
    "Данните на този профил ще бъдат изтрити или анонимизирани. Това не може да се отмени. Публичните адреси ще отговарят с 410 най-много седем дни, след което изчезват.",
  confirmAction: "Да, изпълни изтриването",
  confirmCancel: "Отказ",
...
const RU_COPY: OperatorErasureCopy = {
  ...
  confirmTitle: "Выполнить необратимое удаление по запросу",
  confirmDescription:
    "Данные этого аккаунта будут удалены или анонимизированы. Отменить это нельзя. Публичные адреса будут отвечать 410 не более семи дней, затем исчезнут.",
  confirmAction: "Да, выполнить удаление",
