...
const UK_COPY = {
  ...
  countLabels: {
    ...
    legal_acceptances: "прийняття умов",
    content_reports: "надіслані скарги",
    moderation_messages: "листи щодо скарг",
...
const BG_COPY: OperatorErasureCopy = {
  ...
  countLabels: {
    ...
    legal_acceptances: "приемания на условията",
    content_reports: "изпратени сигнали",
    moderation_messages: "писма по сигнали",
...
const RU_COPY: OperatorErasureCopy = {
  ...
  countLabels: {
    ...
    legal_acceptances: "принятия условий",
    content_reports: "отправленные жалобы",
    moderation_messages: "письма по жалобам",
