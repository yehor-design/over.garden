...
const HOME_CONTENT: Record<PublicLocale, LocalizedHomeContent> = {
  uk: {
    title: "OverGarden",
    description:
      "Ведіть живий датований запис про кожну рослину, яку вирощуєте.",
    eyebrow: "OverGarden",
    heading: "Ведіть живу історію кожної рослини, яку вирощуєте.",
    intro:
      "Зберігайте датовані нотатки й фото про одну й ту саму рослину, а корисні частини публікуйте як доказ лише тоді, коли самі цього хочете.",
    primaryCta: "Почати перший запис",
    secondaryCta: "Відкрити простір",
    featureCards: [
      {
        title: "Історія об'єкта",
        body: "Одна рослина, багато датованих спостережень, без загублених порад із чату.",
      },
      {
        title: "Приватно за замовчуванням",
        body: "Точне місце не показується; для публічного шару доступний лише прихований або грубий регіональний рівень.",
      },
      {
        title: "Публічний доказ пізніше",
        body: "Публікуйте вибрані записи тільки після того, як приватна історія вже існує.",
      },
    ],
    sectionTitle: "Першою корисною дією є збережений запис.",
    sectionBody:
      "Пілот OverGarden тримається на одній конкретній поведінці: створити об'єкт рослини, зберегти перше спостереження і повернутися до тієї самої рослини, коли щось змінилося.",
  },
  bg: {
    title: "OverGarden",
    description:
      "Водете жив, датиран запис за всяко растение, което отглеждате.",
    eyebrow: "OverGarden",
    heading: "Водете жива история на всяко растение, което отглеждате.",
    intro:
      "Запазвайте датирани бележки и снимки за едно и също растение, после публикувайте полезните части като доказателство само когато решите.",
    primaryCta: "Започнете първи запис",
    secondaryCta: "Отворете работното място",
    featureCards: [
      {
        title: "История на обекта",
        body: "Едно растение, много датирани наблюдения, без изгубени съвети от чат.",
      },
      {
        title: "Първо лично",
        body: "Точното място не се показва; публичният слой остава скрит или само на груб регион.",
      },
      {
        title: "Публично доказателство по-късно",
        body: "Публикувайте избрани записи само след като личната история вече съществува.",
      },
    ],
    sectionTitle: "Първото полезно действие е запазен запис.",
    sectionBody:
      "Пилотът на OverGarden проверява една конкретна поведенческа стъпка: създаване на растение, първо наблюдение и връщане към същото растение, когато нещо се промени.",
  },
  ru: {
    title: "OverGarden",
    description:
      "Ведите живую датированную историю каждого растения, которое выращиваете.",
    eyebrow: "OverGarden",
    heading: "Ведите живую историю каждого растения, которое выращиваете.",
    intro:
      "Сохраняйте датированные заметки и фото одной и той же культуры, а полезные части публикуйте как доказательство только тогда, когда сами этого хотите.",
    primaryCta: "Начать первую запись",
    secondaryCta: "Открыть пространство",
    featureCards: [
      {
        title: "История объекта",
        body: "Одно растение, много датированных наблюдений, без потерянных советов из чата.",
      },
      {
        title: "Сначала приватно",
        body: "Точное место не показывается; публичный слой остается скрытым или только на грубом уровне региона.",
      },
      {
        title: "Публичное доказательство позже",
        body: "Публикуйте выбранные записи только после того, как приватная история уже существует.",
      },
    ],
    sectionTitle: "Первое полезное действие - сохраненная запись.",
    sectionBody:
      "Пилот OverGarden проверяет одну конкретную привычку: создать объект растения, сохранить первое наблюдение и вернуться к той же культуре, когда что-то изменилось.",
  },
};
