...
/**
 * The reader's own pages: the feed they follow, Activity and Bookmarks, each
 * under one header (`OVE-456`).
 *
 * They were four tabs over one strip. The shell's navigation and its account
 * menu reach each of them now, so the strip — and the helper that built it — is
 ...
 */
export type SocialTab = "feed" | "notifications" | "bookmarks";
