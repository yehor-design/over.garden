/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/media-staging/wrangler.jsonc cloudflare/media-staging/worker-configuration.d.ts` (hash: ba1903cca7001be68ed4b02d396f175e)
...
interface __BaseEnv_Env {
	...
	EPHEMERAL_MEDIA_COMMIT_STATUS_URL: "https://over.garden/api/media/staging/commit-status";
	EPHEMERAL_MEDIA_PUBLIC_BASE_URL: "https://media.over.garden";
	EPHEMERAL_MEDIA_PROTOCOL_VERSION: "ove346.ephemeralMediaStaging.v1";
	EPHEMERAL_MEDIA_RECEIPT_CURRENT_VERSION: "1";
	MEDIA_STAGING_SESSIONS: DurableObjectNamespace<import("./src/index").MediaStagingSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MediaStagingSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EPHEMERAL_MEDIA_CAPABILITY_CURRENT_VERSION" | "EPHEMERAL_MEDIA_COMMIT_STATUS_URL" | "EPHEMERAL_MEDIA_PUBLIC_BASE_URL" | "EPHEMERAL_MEDIA_PROTOCOL_VERSION" | "EPHEMERAL_MEDIA_RECEIPT_CURRENT_VERSION">> {}
}
