...
function alignedFixture(): Record<string, string> {
  return {
    "AGENTS.md": [
      ...
      "ADR-0020 is the current Stable Registry migration-allocation authority.",
    ...
    "docs/STABLE_REGISTRY.md": [
      ...
      "ADR-0020 allocates migration 0027 to OVE-328 and migration 0028 to OVE-258.",
    ...
    "docs/MIGRATION_ALLOCATION.md": [
      ...
      "0027 | OVE-328",
      "0028 | OVE-258",
      "No SQL migration | OVE-327",
      "No SQL migration | OVE-259",
    ...
    "docs/adr/ADR-0020-stable-registry-migration-allocation.md": [
      "ADR-0020 is accepted and supersedes the migration-allocation clauses of ADR-0016.",
      "Status: Accepted",
      "Current Stable Registry authority: ADR-0016 with ADR-0020 for migration allocation.",
      "Migration 0027 belongs to OVE-328 and migration 0028 belongs to OVE-258.",
      "OVE-327 and OVE-259 have no SQL migration.",
    ].join("\n"),
    ...
    "docs/SDD_VERTICAL_SLICE_ROADMAP.md":
      "Current Stable Registry work follows ADR-0016 observed-capture releases and ADR-0020 migration allocation, and never treats source capture as product completeness.",
    ...
    "docs/TECH_STACK_DECISIONS.md":
      "ADR-0016 is Stable Registry authority and ADR-0020 owns the migration-allocation amendment.",
...
describe("check-stable-registry-canon", () => {
  ...
  it("rejects manifest semantics or migration reservations that drift", () => {
    ...
    files["docs/MIGRATION_ALLOCATION.md"] = files[
      "docs/MIGRATION_ALLOCATION.md"
    ].replace("0027 | OVE-328", "0027 | OVE-258");
  ...
  it("rejects stale allocation wording and an implicit migration for a no-SQL owner", () => {
    const files = alignedFixture();
    files["docs/STABLE_REGISTRY.md"] = files["docs/STABLE_REGISTRY.md"].replace(
      "ADR-0020 allocates migration 0027 to OVE-328 and migration 0028 to OVE-258.",
      "ADR-0020 allocates migration 0027 to OVE-258 and migration 0028 to OVE-259.",
    );
    files["docs/MIGRATION_ALLOCATION.md"] = files[
      "docs/MIGRATION_ALLOCATION.md"
    ].replace("No SQL migration | OVE-259", "0029 | OVE-259");

    const receipt = evaluateStableRegistryCanon(files);

    expect(receipt.violations).toEqual(
      expect.arrayContaining([
        expect.objectContaining({ code: "stale_migration_allocation" }),
        expect.objectContaining({ code: "no_sql_migration_owner_drift" }),
      ]),
    );
  });
