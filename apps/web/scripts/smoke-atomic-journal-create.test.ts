...
// The one entry composer (OVE-486) is the only create composer since the
// combined first-entry form was removed (ADR-0035 D1).
const CREATE_COMPOSERS = ["src/components/garden/entry-composer.tsx"] as const;
